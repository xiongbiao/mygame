...
import erb.unicomedu.adapter.TreeViewAdapter.TreeNode;
...
public class SuperTreeViewAdapter extends BaseExpandableListAdapter {
    ...
    public void setHeight(int height){
    	TreeViewAdapter.ItemHeight = height; 
    } 
	...
	public ExpandableListView getExpandableListView() {
		...
		superTreeView.setCacheColorHint(Color.TRANSPARENT);
	...
	public View getChildView(int groupPosition, int childPosition,boolean isLastChild, View convertView, ViewGroup parent) {
		...
		final TreeViewAdapter treeViewAdapter = new TreeViewAdapter(this.parentContext,60);
		...
		treeView.setOnGroupExpandListener(new OnGroupExpandListener() {
			...
			public void onGroupExpand(int groupPosition) {
				...
				AbsListView.LayoutParams lp = new AbsListView.LayoutParams(
						...
						(treeNode.childs.size()+1)*TreeViewAdapter.ItemHeight   );
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		ListTitle listTitle; 
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.filter_list_title, null);
			listTitle = new ListTitle();
			listTitle.mListTitle = (TextView)convertView.findViewById(R.id.filter_list_title);
			listTitle.mListTitleBG = (LinearLayout)convertView.findViewById(R.id.filter_list_title_bg);
			convertView.setTag(listTitle);
		}
		
		listTitle = (ListTitle)convertView.getTag();
		
		listTitle.mListTitleBG.setBackgroundResource(R.drawable.filter_list_title_pass);
		listTitle.mListTitle.setText(((TreeVo)getGroup(groupPosition)).getTreeName());
		listTitle.mListTitle.setTextColor(parentContext.getResources().getColor(R.color.black));
		if(isExpanded){
			listTitle.mListTitle.setTextColor(parentContext.getResources().getColor(R.color.white));
			listTitle.mListTitleBG.setBackgroundResource(R.drawable.filter_list_title);
		}
		AbsListView.LayoutParams lp = new AbsListView.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,TreeViewAdapter.ItemHeight);
