...
public class TeacherSearchActivity extends PublicActivity implements OnClickListener{
	...
	private void init(){
		...
		mKeyUtil.setUrlType(Def.Teacher_KEY);
		...
		mSearchValue = (EditText)findViewById(R.id.teacher_search_value);
		mSearchValue.setOnKeyListener(onKey); 
		
		mBack = (ImageButton) findViewById(R.id.teacher_search_back);
		mBack.setOnClickListener(this);
		mSearch = (ImageButton) findViewById(R.id.teacher_search);
	...
	public void onClick(View v) {
		...
		if (v instanceof TextView && v.getId()< 0) {
				...
				Intent mIntent = new Intent(this,TeacherResultActivity.class);  
