...
public class ReadSearchActivity extends PublicActivity implements OnClickListener{
	@Override
	...
	private String TAG = "ReadSearchActivity";
	...
	private void init(){
		...
		mKeyUtil.setUrlType(Def.Read_KEY);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.read_search);
		LogUtil.d(TAG, "ReadSearchActivity ~onCreate begin");
		init();
	}
	...
	public void onClick(View v) {
		...
		if (v instanceof TextView && v.getId()< 0) {
				...
				Intent mIntent = new Intent(this,ReadResultActivity.class);  
