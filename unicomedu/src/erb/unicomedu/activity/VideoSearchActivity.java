...
public class VideoSearchActivity extends PublicActivity implements OnClickListener{
	...
	private void init(){
		...
		mKeyUtil.setUrlType(Def.Video_KEY);
	...
	public void onClick(View v) {
		...
		if (v instanceof TextView && v.getId()< 0) {
				...
				Intent mIntent = new Intent(this,VideoResultActivity.class);  
