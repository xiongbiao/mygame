 ...
 * 阅读部分
 */
public class ReadActivity  extends PublicActivity implements OnClickListener,OnItemClickListener{
	...
	protected void onResume() {
		...
		isModel(Def.MODEl_RE_LIST, className,fromClassName,null);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.online_read);
	...
	private void updateFilterButtonBackground(int viewId){
		switch (viewId) {
			...
			case R.id.search_value:
				Intent mIntent = new Intent(this,ReadSearchActivity.class);  
	...
	private class GetDataTask extends AsyncTask<Void, Void, List<ReadVo>> {
		...
		protected void onPostExecute(List<ReadVo> data) {
			...
			if(readBaseAdpter==null){
				readBaseAdpter = new ReadAdapter(ReadActivity.this, R.layout.obj_item, data);
