...
//                connConfig.setTruststorePath("/system/etc/security/cacerts.bks");
    ...
    private class RegisterTask implements Runnable {
        ...
        @Override
		public void run() {
            LogUtil.i(LOGTAG, "RegisterTask.run()...");
            if (!xmppManager.isRegistered()) {
            	//注册---------
            	SIMCardInfo mc =	MyApplication.mSIMCard;
                final String newUsername = newRandomUUID();
                final String newPassword = mc.getImsi();
                ...
                PacketListener packetListener = new PacketListener() {
					...
					public void processPacket(Packet packet) {
                        LogUtil.d("RegisterTask.PacketListener",
                                "processPacket().....");
                        LogUtil.d("RegisterTask.PacketListener", "packet="
                                + packet.toXML());
                        ...
                        if (packet instanceof IQ) {
                            ...
                            if (response.getType() == IQ.Type.ERROR) {
                                ...
                                LogUtil.d(LOGTAG, "username=" + newUsername);
                                LogUtil.d(LOGTAG, "password=" + newPassword);
                                ...
                                editor.putString(Constants.XMPP_PASSWORD,
                                        newPassword);
                                editor.commit();
                                LogUtil.i(LOGTAG, "Account registered successfully");
                                xmppManager.runTask();
                            }
                        }
                    }
                ...
                LogUtil.i(LOGTAG, "Account registered already");
                xmppManager.runTask();
            }
        }
    }
...
//            if (!xmppManager.isAuthenticated()) {
                ...
                LogUtil.d(LOGTAG, "用户登录----结束--------------");

//            } else {
                LogUtil.i(LOGTAG, "Logged in already");
                xmppManager.runTask();
                LogUtil.d(LOGTAG, "已经用户登录------------------");
