...
public class ListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mContentView = moreView.findViewById(R.information.listview_footer_content);
		mProgressBar = moreView.findViewById(R.information.listview_footer_progressbar);
		mHintView = (TextView)moreView.findViewById(R.information.listview_footer_hint_textview);
	}
