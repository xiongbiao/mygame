...
public class InfoListView extends ListView implements OnScrollListener {
	private boolean head;    //设置头部是否隐藏
	private boolean foot;     //设置底部是否隐藏
	private boolean remove = false; //是否移除底部
	...
	private void initWithContext(Context context) {
		...
		mHeaderViewContent = (RelativeLayout) mHeaderView.findViewById(R.information.listview_header_content);
		mHeaderTimeView = (TextView) mHeaderView
				.findViewById(R.information.listview_header_time);
...
//			if (height > 15) { // height enough to invoke load
