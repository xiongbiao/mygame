...
public class ListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mArrowImageView = (ImageView)findViewById(R.information.listview_header_arrow);
		mHintTextView = (TextView)findViewById(R.information.listview_header_hint_textview);
		mProgressBar = (ProgressBar)findViewById(R.information.xlistview_header_progressbar);
