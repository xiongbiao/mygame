...
/**
 * This class implements a popup info box (a subclass of AlertDialog) which can
 * be used to display help text, about info, license info, etc.
 */
public class InfoBox extends Dialog {
	 ...
	 * @param button
	 *            Resource ID of the text for the OK button.
	 */
	...
	private void createDialog() {
		...
		layout.addView(buttonHolder, new LinearLayout.LayoutParams(FPAR, WCON));
	...
	/**
	 * Set some link buttons on this dialog. These are buttons that the user can
	 * click to open a URL, e.g. the project page, license, etc.
	 * 
	 * @param labels
	 *            List of button labels as resource IDs.
	 * @param links
	 *            Resource IDs of the URLs for each button.
	 */
	 ...
	 * 
	 * @param text
	 *            Subtitle to display; if null, don't show one.
	 */
